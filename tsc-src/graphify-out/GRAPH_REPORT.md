# Graph Report - C:\Users\Administrator\Downloads\tsc.web\tsc-src  (2026-06-03)

## Corpus Check
- 27 files · ~208,481 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 519 nodes · 1398 edges · 32 communities detected
...
4. `dbPut()` - 49 edges
5. `dbAdd()` - 31 edges
6. `invalidateStandingsCache()` - 17 edges
7. `renderAdminPage()` - 17 edges
8. `renderAdmPalmares()` - 17 edges
9. `activeBombo()` - 17 edges
...
Cohesion: 0.09
Nodes (60): buildBracketRounds(), buildBracketSlots(), getClassifiedFromPhase(), getStandingsForPhase(), openBracketMatchModal(), openSlotRefModal(), refLabel(), resolveSlotRef() (+52 more)

### Community 2 - "Community 2"
Cohesion: 0.1
Nodes (47): invalidateStandingsCache(), removeSlotRef(), rerenderPhaseFromRefTarget(), saveSlotRef(), dbAdd(), dbPut(), dbSubscribe(), _fsNextId() (+39 more)

### Community 3 - "Community 3"
Cohesion: 0.1
Nodes (45): activeBombo(), addBombo(), assignBracketLink(), assignLink(), broadcast(), clearLink(), deleteActiveBombo(), drawNext() (+37 more)

### Community 4 - "Community 4"
Cohesion: 0.07
Nodes (31): _cleanup(), closeBracketMatchModal(), _getAudioCtx(), getPlayoffMatchupsCount(), getTeamLogo(), getWinner(), hexToRgb(), lighten() (+23 more)
...
Cohesion: 0.09
Nodes (37): getForSeason(), liveAvailable(), liveRadarStart(), liveRadarStop(), liveStop(), liveSubscribe(), goAdminPage(), goPublicPage() (+29 more)
...
Cohesion: 0.13
Nodes (20): deleteBracketMatch(), closeCompModal(), deleteComp(), renderAdmComps(), renderCompsGrid(), saveComp(), downloadJSON(), exportFullDB() (+12 more)

### Community 10 - "Community 10"
Cohesion: 0.14
Nodes (12): cloudReady(), uploadImageToCloud(), saveProfile(), closeTeamModal(), deleteTeam(), filterPubTeams(), filterTeamsTable(), renderAdmTeams() (+4 more)

### Community 11 - "Community 11"
Cohesion: 0.25
Nodes (15): brassNote(), crash(), getCtx(), noiseBuffer(), playDrumRoll(), playSnare(), playTada(), radarPing() (+7 more)

### Community 12 - "Community 12"
Cohesion: 0.27
Nodes (10): closeCoinsModal(), filterCoinsTable(), openBulkCoinsModal(), openCoinsModal(), renderAdmCoins(), renderCoinsTable(), saveBulkCoins(), saveCoinsTransaction() (+2 more)
...
- **Thin community `Community 15`** (2 nodes): `color-picker.js`, `openColorPicker()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 16`** (2 nodes): `BRACKET Phase Config Schema`, `BRACKET Phase Type (Elimination)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 17`** (2 nodes): `LIGA Phase Config Schema`, `LIGA Phase Type (Group Stage)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 18`** (2 nodes): `PLAYOFF Phase Config Schema`, `PLAYOFF Phase Type (Aggregate Two-Leg)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 19`** (1 nodes): `firebase-config.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 20`** (1 nodes): `state.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 21`** (1 nodes): `Graphify Knowledge Graph Instructions`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 22`** (1 nodes): `npx serve Launch Command`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 23`** (1 nodes): `Match Data Schema`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 24`** (1 nodes): `Sorteo Lottery Animation Feature`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 25`** (1 nodes): `Admin Password Guard Feature (v1.91)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 26`** (1 nodes): `Google Fonts (Bebas Neue, Barlow, Barlow Condensed)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 27`** (1 nodes): `equipos_tsc_60.csv Seed Data`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 28`** (1 nodes): `HISTORIAL_TSC_v2.1.xlsx Historical Data`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 29`** (1 nodes): `Rationale: IndexedDB Browser-Native (No Backend)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 30`** (1 nodes): `Rationale: Draft Phase Status Hides from Public`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 31`** (1 nodes): `Rationale: Window Load Order is Critical`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `dbGetAll()` connect `Community 1` to `Community 0`, `Community 2`, `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 8`, `Community 9`, `Community 10`, `Community 12`?**
  _High betweenness centrality (0.297) - this node is a cross-community bridge._
- **Why does `showToast()` connect `Community 2` to `Community 0`, `Community 1`, `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `Community 12`?**
  _High betweenness centrality (0.187) - this node is a cross-community bridge._
- **Why does `dbGet()` connect `Community 1` to `Community 0`, `Community 2`, `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `Community 12`?**
