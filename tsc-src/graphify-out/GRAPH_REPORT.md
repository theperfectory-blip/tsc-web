...
## Corpus Check
- 47 files · ~1,117,793 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2700 nodes · 7081 edges · 47 communities detected
- Extraction: 81% EXTRACTED · 19% INFERRED · 0% AMBIGUOUS · INFERRED: 1371 edges (avg confidence: 0.8)
...
Cohesion: 0.01
Nodes (61): dynCall(), I(), t(), _a, an, bc, cc, clone() (+53 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (145): rgbStr(), confirmCrop(), getBombos(), ac, _activateAction(), _addInactiveAction(), _addInactiveBinding(), al() (+137 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (307): authForgotPassword(), buildBracketRounds(), buildBracketSlots(), closeBracketMatchModal(), deleteBracketMatch(), getClassifiedFromPhase(), getPlayoffMatchupsCount(), getStandingsForPhase() (+299 more)

### Community 3 - "Community 3"
Cohesion: 0.01
Nodes (54): loop(), scaleBracket(), spawnRocket(), computeBounds(), toTrianglesDrawMode(), histShowPrev(), _pubHCount(), _palmOpenSala() (+46 more)
...
Cohesion: 0.04
Nodes (122): resize(), addPalmaresRecord(), aggregatePalmaresByTeam(), buildCase(), buildInfoPanel(), closePalmaresModals(), createNewCopa(), deleteCopaAndRefresh() (+114 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (114): _cleanup(), _calHeroGoH2H(), openColorPicker(), frame(), getVariant(), init(), resize(), setVariant() (+106 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (38): teamLogoHtml(), _cropApply(), cropZoomSlider(), _donutSVG(), _injectCropModal(), _injectProfileModal(), _loadTeamStats(), _onProfileClose() (+30 more)

### Community 8 - "Community 8"
Cohesion: 0.04
Nodes (100): _authErrorMsg(), _authEsc(), authSubmit(), _injectAuthModal(), _loadProfile(), onAuthInit(), openAuthModal(), _renderAuthModalMode() (+92 more)

### Community 9 - "Community 9"
Cohesion: 0.04
Nodes (50): locateFile(), A(), B(), C(), D(), e(), F(), G() (+42 more)
...
Cohesion: 0.03
Nodes (6): bt(), gc, jt(), qt, Ut(), wt()

### Community 13 - "Community 13"
Cohesion: 0.04
Nodes (9): dh, ic, _isActiveAction(), kl, _lendControlInterpolant(), rh, _takeBackControlInterpolant(), yl (+1 more)
...
- **Why does `add()` connect `Community 3` to `Community 0`, `Community 1`, `Community 2`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 9`?**
  _High betweenness centrality (0.078) - this node is a cross-community bridge._
- **Why does `ks()` connect `Community 0` to `Community 1`, `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 9`, `Community 11`, `Community 12`, `Community 13`?**
