# Graph Report - C:\Users\Administrator\Downloads\tsc.web\tsc-src  (2026-09-10)

## Corpus Check
- 58 files · ~1,292,917 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2889 nodes · 7372 edges · 56 communities detected
...
- `writeField()` --calls--> `add()`  [INFERRED]
  C:\Users\Administrator\Downloads\tsc.web\tsc-src\prototipo_yunas\tools\write-attrs.js → C:\Users\Administrator\Downloads\tsc.web\tsc-src\assets\vendor\three\three.min.js
...
Cohesion: 0.01
Nodes (84): scaleBracket(), _fxSetLoaderProgress(), histShowPrev(), _palmOpenSala(), _palmReorderPointerMove(), _palmSetSalaLoaderProgress(), _palmShowSalaLoader(), _cropClamp() (+76 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (134): GLTFCubicSplineQuaternionInterpolant, ac, _activateAction(), _addInactiveAction(), _addInactiveBinding(), al(), ao, as() (+126 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (276): authForgotPassword(), buildBracketRounds(), buildBracketSlots(), _cleanup(), closeBracketMatchModal(), deleteBracketMatch(), fixBracketSlotHeights(), getClassifiedFromPhase() (+268 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (12): bc, ea, fs(), In, mc, ne, on, qs (+4 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (44): N(), DRACOLoader, addMorphTargets(), addPrimitiveAttributes(), addUnknownExtensionsToUserData(), assignExtrasToUserData(), buildNodeHierarchy(), computeBounds() (+36 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (79): Particle, teamLogoHtml(), diff(), openCard(), A(), B(), C(), D() (+71 more)

### Community 6 - "Community 6"
Cohesion: 0.04
Nodes (133): _authEsc(), renderAuthUI(), renderTopbarBrand(), hexToRgb(), lighten(), liveRadarStart(), liveRadarStop(), liveStop() (+125 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (115): resize(), openColorPicker(), ch(), en(), fn(), rc(), rcp(), _play() (+107 more)

### Community 8 - "Community 8"
Cohesion: 0.04
Nodes (103): _calHeroGoComp(), frame(), init(), resize(), setVariant(), stop(), wake(), _applyFilters() (+95 more)
...
Cohesion: 0.05
Nodes (8): rgbStr(), OptionFile, bo, co, equals(), lineTo(), moveTo(), oo

### Community 13 - "Community 13"
Cohesion: 0.05
Nodes (60): _authErrorMsg(), authSignOut(), authSubmit(), _injectAuthModal(), _loadProfile(), onAuthInit(), openAuthModal(), _renderAuthModalMode() (+52 more)
...
Cohesion: 0.07
Nodes (46): getVariant(), _bindListeners(), _clearPendingTokenRemoval(), _clearToken(), clearUserToken(), _currentTimezone(), disable(), _disableLocalPushFlagAndToken() (+38 more)
...
Cohesion: 0.08
Nodes (35): _pbBracketCards(), _pbBracketMount(), _pbCrestMini(), _pbCrestTree(), _pbDesktopTreeHTML(), _pbEsc(), _pbFitTree(), _pbFmtDate() (+27 more)
...
Cohesion: 0.13
Nodes (28): _calCenterAnchorScroll(), _calCommitStage(), _calCtaBtn(), _calFormatDay(), _calHeroGoH2H(), _calHeroHtml(), _calInitHeroCountdown(), _calJornadaViewerDate() (+20 more)
...
Cohesion: 0.38
Nodes (9): addToTeam(), findPlayerId(), findTeamIndex(), playerName(), readRoster(), removeFromTeam(), rosterOffset(), teamName() (+1 more)

### Community 28 - "Community 28"
Cohesion: 0.52
Nodes (5): bloques(), capaPC(), checksums(), cifrar(), descifrar()

### Community 29 - "Community 29"
Cohesion: 0.47
Nodes (4): bitsOf(), findByName(), setField(), writeBits()
...
- **Thin community `Community 34`** (2 nodes): `LIGA Phase Config Schema`, `LIGA Phase Type (Group Stage)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 35`** (2 nodes): `BRACKET Phase Config Schema`, `BRACKET Phase Type (Elimination)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 36`** (2 nodes): `PLAYOFF Phase Config Schema`, `PLAYOFF Phase Type (Aggregate Two-Leg)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 37`** (1 nodes): `firebase-config.example.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 38`** (1 nodes): `firebase-config.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 39`** (1 nodes): `pes5-crypt.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 40`** (1 nodes): `pes5-editor.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 41`** (1 nodes): `state.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 42`** (1 nodes): `snapshot.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 43`** (1 nodes): `xor-diff.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 44`** (1 nodes): `convert.mjs`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 45`** (1 nodes): `Graphify Knowledge Graph Instructions`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 46`** (1 nodes): `npx serve Launch Command`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 47`** (1 nodes): `Match Data Schema`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 48`** (1 nodes): `Admin Password Guard Feature (v1.91)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 49`** (1 nodes): `Google Fonts (Bebas Neue, Barlow, Barlow Condensed)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 50`** (1 nodes): `equipos_tsc_60.csv Seed Data`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 51`** (1 nodes): `HISTORIAL_TSC_v2.1.xlsx Historical Data`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 52`** (1 nodes): `Rationale: IndexedDB Browser-Native (No Backend)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 53`** (1 nodes): `Rationale: Draft Phase Status Hides from Public`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 54`** (1 nodes): `Rationale: Window Load Order is Critical`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 55`** (1 nodes): `Drumroll Sound Effect`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `set()` connect `Community 0` to `Community 1`, `Community 2`, `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `Community 13`, `Community 14`, `Community 17`, `Community 18`, `Community 20`, `Community 21`?**
  _High betweenness centrality (0.123) - this node is a cross-community bridge._
- **Why does `add()` connect `Community 6` to `Community 0`, `Community 1`, `Community 2`, `Community 3`, `Community 4`, `Community 5`, `Community 7`, `Community 8`, `Community 10`, `Community 12`, `Community 13`, `Community 15`, `Community 17`, `Community 18`, `Community 19`, `Community 26`?**
  _High betweenness centrality (0.075) - this node is a cross-community bridge._
- **Why does `copy()` connect `Community 0` to `Community 1`, `Community 3`, `Community 4`, `Community 5`, `Community 7`, `Community 9`, `Community 11`, `Community 12`, `Community 14`, `Community 18`, `Community 20`, `Community 21`?**
...
- **Are the 121 inferred relationships involving `dbGetAll()` (e.g. with `getTeamLogo()` and `renderBracket()`) actually correct?**
  _`dbGetAll()` has 121 INFERRED edges - model-reasoned connections that need verification._
- **Are the 86 inferred relationships involving `dbGet()` (e.g. with `renderBracket()` and `getStandingsForPhase()`) actually correct?**
  _`dbGet()` has 86 INFERRED edges - model-reasoned connections that need verification._