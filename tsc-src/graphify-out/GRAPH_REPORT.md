# Graph Report - C:\Users\Administrator\Downloads\tsc.web\tsc-src  (2026-06-07)

## Corpus Check
- 30 files · ~267,839 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 623 nodes · 1564 edges · 38 communities detected
- Extraction: 69% EXTRACTED · 31% INFERRED · 0% AMBIGUOUS · INFERRED: 482 edges (avg confidence: 0.8)
...
4. `dbPut()` - 49 edges
5. `dbAdd()` - 30 edges
6. `renderBracket()` - 18 edges
7. `invalidateStandingsCache()` - 18 edges
8. `activeBombo()` - 18 edges
9. `renderAdminPage()` - 17 edges
...
Cohesion: 0.07
Nodes (65): addPalmaresRecord(), aggregatePalmaresByTeam(), buildCase(), buildInfoPanel(), closeChampionFullscreen(), closePalmaresModals(), createNewCopa(), deleteCopa() (+57 more)

### Community 1 - "Community 1"
Cohesion: 0.08
Nodes (65): getStandingsForPhase(), openSlotRefModal(), resolveSlotRef(), saveBracketMatch(), openCoinsHistory(), openCompModal(), dbAdd(), dbDelete() (+57 more)
...
Cohesion: 0.07
Nodes (39): _authErrorMsg(), _authEsc(), authForgotPassword(), authSignOut(), authSubmit(), _injectAuthModal(), _loadProfile(), onAuthInit() (+31 more)

### Community 4 - "Community 4"
Cohesion: 0.11
Nodes (41): _applyFilters(), _buildH2HPanel(), _classifyOutcomeFIFA(), _computeHistoricalStandings(), computeResultado(), _currentHistContainer(), _esc(), exportHistoryToExcel() (+33 more)

### Community 5 - "Community 5"
Cohesion: 0.08
Nodes (29): buildBracketRounds(), buildBracketSlots(), _cleanup(), closeBracketMatchModal(), _getAudioCtx(), getClassifiedFromPhase(), getPlayoffMatchupsCount(), getTeamLogo() (+21 more)

### Community 6 - "Community 6"
Cohesion: 0.13
Nodes (34): invalidateStandingsCache(), removeSlotRef(), closeCoinsModal(), filterCoinsTable(), openBulkCoinsModal(), openCoinsModal(), renderAdmCoins(), renderCoinsTable() (+26 more)

### Community 7 - "Community 7"
Cohesion: 0.1
Nodes (34): liveRadarStart(), liveRadarStop(), liveStop(), liveSubscribe(), _subscribeAdminMatchesLive(), _applyPubSidebar(), closePubSidebar(), goAdminPage() (+26 more)

### Community 8 - "Community 8"
Cohesion: 0.08
Nodes (33): deleteBracketMatch(), closeCompModal(), deleteComp(), renderAdmComps(), renderCompsGrid(), saveComp(), downloadJSON(), exportFullDB() (+25 more)
...
Cohesion: 0.11
Nodes (22): addToGroup(), calcGroupStandings(), closeCriteriaModal(), closeGroupAssignModal(), criteriaDisable(), criteriaDragEnd(), criteriaDrop(), criteriaDropOnContainer() (+14 more)

### Community 11 - "Community 11"
Cohesion: 0.13
Nodes (26): toggleSound(), brassNote(), crash(), getCtx(), getVolume(), noiseBuffer(), playDrumRoll(), playSnare() (+18 more)
...
- **Thin community `Community 19`** (2 nodes): `color-picker.js`, `openColorPicker()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 20`** (2 nodes): `LIGA Phase Config Schema`, `LIGA Phase Type (Group Stage)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 26`** (1 nodes): `convert.mjs`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 27`** (1 nodes): `Graphify Knowledge Graph Instructions`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 28`** (1 nodes): `npx serve Launch Command`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 29`** (1 nodes): `Match Data Schema`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 30`** (1 nodes): `Admin Password Guard Feature (v1.91)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 31`** (1 nodes): `Google Fonts (Bebas Neue, Barlow, Barlow Condensed)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 32`** (1 nodes): `equipos_tsc_60.csv Seed Data`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 33`** (1 nodes): `HISTORIAL_TSC_v2.1.xlsx Historical Data`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 34`** (1 nodes): `Rationale: IndexedDB Browser-Native (No Backend)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 35`** (1 nodes): `Rationale: Draft Phase Status Hides from Public`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 36`** (1 nodes): `Rationale: Window Load Order is Critical`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 37`** (1 nodes): `Drumroll Sound Effect`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `dbGetAll()` connect `Community 1` to `Community 0`, `Community 2`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `Community 11`?**
  _High betweenness centrality (0.216) - this node is a cross-community bridge._
- **Why does `showToast()` connect `Community 6` to `Community 0`, `Community 1`, `Community 2`, `Community 3`, `Community 4`, `Community 5`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `Community 11`?**
  _High betweenness centrality (0.162) - this node is a cross-community bridge._
- **Why does `dbGet()` connect `Community 1` to `Community 0`, `Community 2`, `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 9`, `Community 10`?**
