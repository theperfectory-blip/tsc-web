# Graph Report - C:\Users\Administrator\Downloads\tsc.web\tsc-src  (2026-07-14)

## Corpus Check
- 41 files · ~915,306 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2698 nodes · 6901 edges · 46 communities detected
- Extraction: 83% EXTRACTED · 17% INFERRED · 0% AMBIGUOUS · INFERRED: 1202 edges (avg confidence: 0.8)
...
- `buildNodeHierarchy()` --calls--> `bind()`  [INFERRED]
  C:\Users\Administrator\Downloads\tsc.web\tsc-src\assets\vendor\three\GLTFLoader.js → C:\Users\Administrator\Downloads\tsc.web\tsc-src\assets\vendor\three\three.min.js
...
Cohesion: 0.02
Nodes (308): authForgotPassword(), buildBracketRounds(), buildBracketSlots(), closeBracketMatchModal(), deleteBracketMatch(), getClassifiedFromPhase(), getPlayoffMatchupsCount(), getStandingsForPhase() (+300 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (123): _activateAction(), _addInactiveAction(), _addInactiveBinding(), al(), ao, as(), bind(), _bindAction() (+115 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (45): _a, add(), an, At(), cc, clampPoint(), clone(), closestPointToPoint() (+37 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (21): Particle, rgbStr(), _emscripten_memcpy_big(), cn, ea, ec, fs(), lineTo() (+13 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (32): _cleanup(), loop(), scaleBracket(), spawnRocket(), _pubHCount(), _palmOpenSala(), _palmReorderPointerMove(), _palmSetSalaLoaderProgress() (+24 more)
...
Cohesion: 0.03
Nodes (28): teamLogoHtml(), computeBounds(), toTrianglesDrawMode(), histShowPrev(), applyMatrix4(), bi, constructor(), Di (+20 more)

### Community 7 - "Community 7"
Cohesion: 0.04
Nodes (109): resize(), _play(), _initPubSidebarHover(), _esc(), _escAttr(), getPalmaresMedia(), getTrophyGlbUrl(), getTrophyStyles() (+101 more)
...
Cohesion: 0.05
Nodes (91): _calCommitStage(), _calCtaBtn(), _calFormatDay(), _calHeroGoComp(), _calHeroGoH2H(), _calHeroHtml(), _calInitHeroCountdown(), calLblNavMonth() (+83 more)
...
Cohesion: 0.03
Nodes (14): ac, bl, Ga, gc, ia, jl(), Na, Oa (+6 more)

### Community 12 - "Community 12"
Cohesion: 0.04
Nodes (79): _authErrorMsg(), _authEsc(), authSignOut(), authSubmit(), _injectAuthModal(), _loadProfile(), onAuthInit(), openAuthModal() (+71 more)

### Community 13 - "Community 13"
Cohesion: 0.05
Nodes (41): _getAudioCtx(), Rocket, _soundExplosion(), _soundRocketLaunch(), liveRadarStart(), _palmApplyVol(), _palmAudio(), _PalmSmoke (+33 more)
...
- **Why does `set()` connect `Community 3` to `Community 0`, `Community 1`, `Community 2`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `Community 11`, `Community 12`, `Community 13`, `Community 15`, `Community 17`, `Community 19`?**
  _High betweenness centrality (0.136) - this node is a cross-community bridge._
- **Why does `add()` connect `Community 2` to `Community 0`, `Community 1`, `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 9`, `Community 12`, `Community 15`, `Community 16`?**
  _High betweenness centrality (0.094) - this node is a cross-community bridge._
- **Why does `copy()` connect `Community 2` to `Community 1`, `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 8`, `Community 10`, `Community 11`, `Community 14`, `Community 17`, `Community 18`, `Community 19`?**
